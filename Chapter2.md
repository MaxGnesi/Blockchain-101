...
```mermaid
graph LR
    A["📱 Wallet<br/>Create"] -->|1. Sign| B["✍️ Signed<br/>Tx"]
    B -->|2. Broadcast| C["🌐 P2P<br/>Network"]
    C -->|3. Queue| D["⏳ Mempool"]
    D -->|4. Select| E["⛏️ Validator<br/>Block"]
    E -->|5. Confirm| F["✅ Consensus"]
    F -->|6. Update| G["💰 State<br/>Changed"]
    G -->|7. Done| H["📬 Receipt"]
